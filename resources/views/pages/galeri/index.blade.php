...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        fetch('https://cms.rkicoop.co.id/api.php?act=gallery&id_dekopin=2787')
            ...
            .then(data => {
                ...
                data.forEach(item => {
                    ...
                    title.textContent = item.id_kategori;
